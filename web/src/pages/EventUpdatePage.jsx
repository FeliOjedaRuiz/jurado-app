	...
	return (
		<GeneralLayout>
			<div className="flex flex-col bg-gray-200 w-full p-8 items-center lg:justify-center">
				<div className="font-bold text-2xl lg:text-4xl text-brand-purple-800 mb-12 mt-4 lg:mt-0 lg:mb-8">
					<p>{event.name} </p>
				</div>
				<p className="text-xl text-brand-purple-800 font-medium mb-2">
					Editar evento
				</p>
