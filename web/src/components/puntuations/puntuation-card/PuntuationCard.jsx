	...
	return (
		<div className="bg-white p-7 rounded-2xl shadow-md m-10">
			<div className="flex justify-between items-center">
				<p className="text-lg font-bold text-brand-purple-700 text-center">
					{group.name}
				</p>
				{exists && !edit && (
					<div
						onClick={changeEdit}
						className="flex font-medium text-brand-purple-700"
					>
						<p>Editar</p>
						<EditIcon className={`w-7 h-7 pb-1 text-brand-purple-700`} />
					</div>
				)}
				{exists && edit && (
