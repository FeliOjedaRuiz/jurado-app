		...
		<form onSubmit={handleSubmit(onEventSubmit)} className="w-full max-w-sm">
			<div className="mb-6">
				...
				<div className="flex">
					...
					/>
					<div className="text-white bg-brand-purple-500 hover:bg-brand-purple-700 text-2xl flex items-center justify-center w-10 h-10 ml-3 focus:ring-2 focus:outline-none focus:ring-brand-purple-300 px-4 rounded-full text-center">
						<p>+</p>
					</div>
				</div>
				{errors.name && (
			...
			<div className="mb-6">
				...
				<div className="flex">
					...
					<div
						onClick={handleClick}
						className="text-white bg-brand-purple-500 hover:bg-brand-purple-700 text-2xl flex items-center justify-center w-10 h-10 ml-3 focus:ring-2 focus:outline-none focus:ring-brand-purple-300 px-4 rounded-full text-center"
					>
						<p>+</p>
					</div>
				</div>
			...
			<button
				type="submit"
				className="text-white bg-brand-purple-500 hover:bg-brand-purple-700 focus:ring-2 focus:outline-none focus:ring-brand-purple-300 mt-3 rounded-full w-full px-4 py-1.5 text-center "
			>
				Guardar
			</button>
		</form>
